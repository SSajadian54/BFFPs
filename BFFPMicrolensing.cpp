...
//#############################################################################
    ...
    sprintf(filnam1,"./files/MONT1/fil/%c%c%c%c%d.dat",'m','o','d','_', count);
    model=fopen(filnam1,"w");
    sprintf(filnam2,"./files/MONT1/fil/%c%c%c%c%d.dat",'d','a','t','_', count);
...
///&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
void LineOfSight(source & s){
    double lonn0, lat0, lonn; 
    int li=int(RandR(1.01,7.9));
