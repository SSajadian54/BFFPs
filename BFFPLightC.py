...
for im in range(1):#Mass_discrete_values
    ...
    for k in range(num):#MonteCarlo  
        ...
        or t0<0.0 or tE<0.0 or tE>120.0 or ChiB<0.0 or ChiR<0.0 or ChiPL1<0.0 or ChiPL2<0.0  or config<1 or config>3 or LMtot!=-1.5): 
        ...
        #######################################################################             
        if(flagd>0 and nd>2 and nm>10 and ei>11203):
            Nwalkers=int(60-im)
